...
-- 基础属性定义
local SCHOOL_NONE     = 0x00 -- 0x00 or 0 (白色)
...
local schoolColors = {
	-- 基础属性颜色
	[SCHOOL_NONE]             = {r = 1.0, g = 1.0, b = 1.0}, -- 0x00 or 0 (白色)
	[SCHOOL_PHYSICAL]         = {r = 1.0, g = 1.0, b = 0.0}, -- 0x01 or 1 (黄色)
	[SCHOOL_HOLY]             = {r = 1.0, g = 1.0, b = 0.5}, -- 0x02 or 2 (浅黄色/金色)
	[SCHOOL_FIRE]             = {r = 1.0, g = 0.5, b = 0.0}, -- 0x04 or 4 (橙色)
	[SCHOOL_NATURE]           = {r = 0.5, g = 1.0, b = 0.5}, -- 0x08 or 8 (浅绿色)
	[SCHOOL_FROST]            = {r = 0.5, g = 1.0, b = 1.0}, -- 0x10 or 16 (浅蓝色/青色)
	[SCHOOL_SHADOW]           = {r = 0.5, g = 0.5, b = 1.0}, -- 0x20 or 32 (紫色)
	[SCHOOL_ARCANE]           = {r = 1.0, g = 0.5, b = 1.0}, -- 0x40 or 64 (粉色/洋红色)

	-- 混合属性颜色（已计算好的平均值）
	[SCHOOL_MASK_HOLYFIRE]    = { r = 1.00, g = 0.75, b = 0.25 }, -- 0x06 or 6 (HOLY + FIRE)
	[SCHOOL_MASK_HOLYSTORM]   = { r = 0.75, g = 1.00, b = 0.50 }, -- 0x0A or 10 (HOLY + NATURE)
	[SCHOOL_MASK_FIRESTORM]   = { r = 0.75, g = 0.75, b = 0.25 }, -- 0x0C or 12 (FIRE + NATURE)
	...
	[SCHOOL_MASK_FROSTSTORM]  = { r = 0.50, g = 1.00, b = 0.75 }, -- 0x18 or 24 (FROST + NATURE)
	[SCHOOL_MASK_ELEMENTAL]   = { r = 0.67, g = 0.83, b = 0.50 }, -- 0x1C or 28 (FIRE + NATURE + FROST)
	...
	[SCHOOL_MASK_SHADOWSTORM] = { r = 0.50, g = 0.75, b = 0.75 }, -- 0x28 or 40 (SHADOW + NATURE)
	[SCHOOL_MASK_SHADOWFROST] = { r = 0.50, g = 0.75, b = 1.00 }, -- 0x30 or 48 (SHADOW + FROST)
	[SCHOOL_MASK_CHROMATIC]   = { r = 0.75, g = 0.83, b = 0.67 }, -- 0x3E or 62 (PHYSICAL + HOLY + FIRE + NATURE + FROST + SHADOW)
	...
	[SCHOOL_MASK_SPELLSTORM]  = { r = 0.75, g = 0.75, b = 0.75 }, -- 0x48 or 72 (ARCANE + NATURE)
	...
	[SCHOOL_MASK_CHAOS]       = { r = 0.70, g = 0.70, b = 0.70 }, -- 0x7C or 124 (FIRE + NATURE + FROST + SHADOW + ARCANE)
	[SCHOOL_MASK_MAGICAL]     = { r = 0.75, g = 0.75, b = 0.75 }, -- 0x7E or 126 (HOLY + FIRE + NATURE + FROST + SHADOW + ARCANE)
	[SCHOOL_MASK_ALL]         = { r = 0.79, g = 0.79, b = 0.71 }, -- 0x7F or 127 (ALL)
}
