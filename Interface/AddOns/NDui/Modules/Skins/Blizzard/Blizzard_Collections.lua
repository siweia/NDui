...
C.themes["Blizzard_Collections"] = function()
	...
	local modelScene = DB.isNewPatch and WardrobeTransmogFrame.ModelScene or WardrobeTransmogFrame.Model
	...
	B.CreateBDFrame(WardrobeOutfitFrame, .7)
	B.CreateSD(WardrobeOutfitFrame)
	...
	B.CreateBD(WardrobeOutfitEditFrame)
	B.CreateSD(WardrobeOutfitEditFrame)
	local bg = B.CreateBDFrame(WardrobeOutfitEditFrame.EditBox, .25)
