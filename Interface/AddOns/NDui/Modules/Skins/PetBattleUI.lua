...
function module:PetBattleUI()
	...
	for index, unit in pairs(units) do
		...
		if index == 1 then
			...
			unit.healthBg:SetPoint("TOPLEFT", unit.ActualHealthBar, -3, 3)
			unit.healthBg:SetPoint("BOTTOMLEFT", unit.ActualHealthBar, -3, -3)
			...
			unit.healthBg:SetPoint("TOPRIGHT", unit.ActualHealthBar, 3, 3)
			unit.healthBg:SetPoint("BOTTOMRIGHT", unit.ActualHealthBar, 3, -3)
	...
	for index, unit in pairs(buddy) do
		...
		unit.healthBg = B.CreateBG(unit.ActualHealthBar)
		unit.healthBg:SetPoint("TOPLEFT", unit.ActualHealthBar, -3, 3)
		unit.healthBg:SetPoint("BOTTOMRIGHT", unit.ActualHealthBar, "TOPLEFT", 39, -10)
	...
	for i = 1, NUM_BATTLE_PETS_IN_BATTLE do
		...
		bg:SetPoint("TOPLEFT", unit.ActualHealthBar, -3, 3)
		bg:SetPoint("BOTTOMRIGHT", unit.ActualHealthBar, "BOTTOMLEFT", 131, -3)
		B.CreateBD(bg)
		B.CreateTex(bg)
	end
	...
	bgLeft:SetPoint("BOTTOMRIGHT", UIParent, "BOTTOM", -1, 4)
	...
	bgRight:SetPoint("BOTTOMLEFT", UIParent, "BOTTOM", 1, 4)
