...
local CLASSES = {
	-- soul
	{
		containers = {22243, 22244, 21340, 21341, 21342, 21872, 211492},
		items = set(6265),
	},
	-- arrow
	{
		containers = {2101, 5439, 7278, 11362, 3573, 3605, 7371, 8217, 2662, 19319, 18714, 29143, 29144, 34105, 34100, 216514, 236864},
		items = set(2512, 2514, 2515, 3029, 3030, 3031, 3464, 9399, 10579, 11285, 12654, 18042, 19316, 24412, 24417, 28053, 28056, 30319, 30611, 31737, 31949, 32760, 33803, 34581, 223648),
	},
	-- bullet
	{
