...
L["ReminderTip"] = "|n특정직업 자체버즈 부족 시 알림.|n인내/지능/전투외침/발바닥/가시/수호/오라등등/Warlock armors/Mage armors/Horn of winter/Righteous fury." -- need translation
...
L["Spec RaidPos"] = "Save Position by Specs" -- need translation
...
L["BN"] = "배틀넷친구"
L["SpecPanel"] = "특성"
L["Change Spec"] = "Change talent" -- need translation
L["Reset Gold"] = "골드정보리셋"
L["Toggle Calendar"] = "Toggle Calendar" -- need translation
L["Toggle Clock"] = "월드시간"
L["WorldMap"] = "월드맵"
...
L["WhiteList"] = "스킬 화이트리스트"
L["BlackList"] = "스킬 블랙리스트"
...
L["UFs RuneTimer"] = "Show DK Runes Timer" -- need translation
...
L["AlertFrames"] = "AlertFrames" -- need translation
L["UIWidgetFrame"] = "미니맵 하단에 특수창 표시|n|n예로 pvp점거"
L["TargetClassPower"] = "Target Nameplate ClassPower" -- need translation
...
L["MinimapHelp"] = "Scroll minimap to zoom in or out, middle click to toggle calendar." -- need translation
