...
L["Tutorial Page3"] = "設定完畢，點擊|cffffcc00套用|r後重載生效。|n|n|cffff0000注意:|r|n|n|cff00ccff小地圖右鍵點擊可以呼出追蹤選單，中鍵打開日曆；|n|n角落的訊息條包含諸多額外的功能，請自行查看；|n|n大部分的設定在控制面板中都可以修改！|r"
L["Help Title"] = "幫助說明"
