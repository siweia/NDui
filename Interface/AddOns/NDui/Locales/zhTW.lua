...
L["Mastery"] = "精通"
L["Versa"] = "應變"
L["Option* Tips"] = "|n帶有*號的選項即時生效，無需重載插件。|n雙擊滑塊選項的標題，即可恢復初始設定。|n點擊部分選項的右側齒輪，可進行拓展設定。"
...
L["JunkMode Enabled"] = "|n點擊將可售出的物品歸類為垃圾。|n當你開啟自動出售垃圾時，這些物品也將一同售出。|n這個列表是帳號共享的。"
...
L["HealthFrequencyTip"] = "|n啟用固定時間刷新后，所設定的時間間隔越短，刷新速度越快。"
L["No key set"] = "未綁定按鍵"
L["KeyIndex"] = "序號"
L["KeyBinding"] = "按鍵"
L["KeyBoundTo"] = "綁定按鍵"
L["Save keybinds"] = "按鍵設置已保存。"
L["Discard keybinds"] = "按鍵設置已撤銷。"
