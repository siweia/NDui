...
L["Instance Intro"] = "\n選擇你想要添加的法術ID所對應的副本。"
L["Priority"] = "優先級"
L["Priority Intro"] = "\n法術監視圖標的顯示優先級。\n\n同一時間存在多個法術時，僅顯示優先級最高的那一個。\n\n可驅散的魔法效果優先級為4，自定義時可以此為基準。\n\n\n\n最高為6，同時高亮該優先級的光環。留空則默認為2。"
...
L["Nameplate AuraFilter"] = "名條法術過濾"
L["WhiteList"] = "白名單"
L["BlackList"] = "黑名單"
L["Details Skin"] = "啓用Details皮膚"
L["Reset your raiddebuffs list?"] = "確定還原為默認的減益列表？"
L["Flash"] = "高亮"
L["Flash Intro"] = "\n勾選后，觸發時將高亮該法術圖標。"
L["Show SpecLevelByShift"] = "按住SHIFT時顯示專精和裝等"
L["Instance Type"] = "\n選擇你要添加的ID所屬副本類型。"
L["Dungeons Intro"] = "\n選擇你要添加的ID所屬地城。"
L["Raid Intro"] = "\n選擇你要添加的ID所屬團隊。"
L["ExplosiveCount"] = "打球統計 - "
L["Explosive Alert"] = "火爆周統計打球數量"