...
L["BossAuraFrame"] = "首領框架"
L["ArenaAuraFrame"] = "競技場框架"
...
L["CustomUnitsTip"] = "|n啟用後，部分目標的名條將以特殊顏色顯示。|n你可以自定義這個顏色和需要染色的目標列表。|n|n在副本内這個功能可能失效。"
...
L["iLvlToShow"] = "物品等級閾值"
L["iLvlToShowTip"] = "|n需要配合過濾低等級裝備使用，單獨歸納低於所設裝等閾值的裝備。"
L["FlatMode"] = "扁平風格按鍵"
L["Shadow"] = "顯示背景陰影邊框"
L["BgTex"] = "顯示背景淺色線條"
L["SkinAlpha"] = "背景淡化透明度"
...
L["FilterAOE"] = "過濾戰團裝綁"
L["FilterLegacy"] = "過濾舊資料片裝備"
L["FilterDecor"] = "过滤房屋裝飾"
...
L["JunkMode Enabled"] = "|n點擊將可售出的物品歸類為垃圾。|n當你開啟自動出售垃圾時，這些物品也將一同售出。|n這個列表是帳號共享的，同時也不會跟隨你的設定導出。|n按住CTRL+ALT並點擊此按鈕，可以清空這個列表。"
...
L["UnlockUI"] = "介面移動"
L["FramePreview"] = "框架預覽"
L["FramePreviewTip"] = "即時依目前設定繪製團隊框架示意，尺寸與光環圖示調整立即可見，無需重載。"
L["PreviewRaidTitle"] = "團隊  %dx%d  |  能量 %d  |  圖示間距 %d"
L["PreviewPartyTitle"] = "小隊  %dx%d  |  能量 %d  |  圖示間距 %d"
L["PreviewAuraInfo1"] = "生命值 %s  |  增益 %dpx×%d  |  減益 %dpx×%d  |  大減益 %s"
L["PreviewAuraInfo2"] = "增益CD %s(%dpx)  |  減益CD %s(%dpx)  (尺寸改動需 /reload)"
L["PreviewOn"] = "開"
L["PreviewOff"] = "關"
L["PreviewCornerInfo"] = "邊角指示器 %s  |  尺寸 %dpx  |  模式 %s  |  %d個"
...
L["PlateCastbarGlowTip"] = "|n當目標施放重要的法術時，在施法條顯示高亮箭頭。"
...
L["MobTypeColoring"] = "副本怪物類型染色"
L["MobTypeColoringTip"] = "|n在副本及隊伍實例中，根據怪物類型為敵方名條染色。|n|nBoss: 被標記為首領或等級高2級的怪物|n精英隊長: 被標記為精英隊長或等級高1級的精英怪物|n精英: 其他精英怪物|n普通: 標準非精英怪物|n|n自訂單位、仇恨、目標及焦點顏色仍有更高優先級。"
L["BossColor"] = "首領顏色"
L["LieutenantColor"] = "精英隊長顏色"
L["MeleeColor"] = "精英顏色"
L["TrivialColor"] = "普通怪物顏色"
...
L["BagSearchTip"] = "|n點擊對背包進行搜索。|n你可以搜索物品的名字或者裝備的部位。|n輸入boe可以直接搜索裝綁，輸入aoe搜索戰團裝綁，輸入任務則搜索任務道具。|n輸入資料片對應的數字編號，搜索來自該資料片的物品。|n|n按ESC鍵清空輸入框。"
...
L["FriendPlateTip"] = "|n啟用後，你可以為友方名條設定單獨的尺寸，以區分敵方名條。|n不啟用，則全部使用敵方名條的設定。|n|n你必須關閉友方名條名字模式才能生效友方獨立尺寸。"
L["NameplateSize"] = "名條尺寸設定"
...
L["MaxDebuffs"] = "最大減益數量"
L["ShowAll"] = "顯示全部"
L["ShowAllOthersGray"] = "顯示全部，他人灰色"
L["ShowDispell"] = "顯示可驅散"
L["BlockOthers"] = "屏蔽他人"
L["DebuffColor"] = "減益法術邊框染色"
L["DebuffColorTip"] = "|n根據減益法術的類型，染色其圖示邊框。"
L["AuraTypeColor"] = "法術類型邊框染色"
L["AuraTypeColorTip"] = "|n根據法術類型，染色此監控組的圖示邊框。"
...
L["IgnoreNoteHelp"] = "你可以雙擊玩家名字為其設定備注。"
...
L["DisableMapPOITooltipFix"] = "關閉大地圖提示修復"
L["DisableMapPOITooltipFixTip"] = "|n勾選後，會停用NDui對大地圖滑鼠提示的污染修復。這可以解決插件衝突引起的滑鼠提示框顯示異常，但會使污染問題重新出現。"
...
L["SingingSocket"] = "特殊插槽增强"
L["SingingSocketTip"] = "|n啟用後，在瑞西纏帶或海妖戒指的寶石頁面添加一個快速選擇寶石的小工具。"
...
L["LoadProfile"] = "加載配置"
L["LoadProfileTip"] = "將當前配置加載到監控中"
L["LoadProfileIndex"] = "加載配置: %s"
L["LoadProfileDefault"] = "已加載默認配置"
L["SaveProfile"] = "保存配置"
L["SaveProfileTip"] = "保存當前設定的監控配置"
L["Profile1Warning"] = "1號配置已被鎖定，無法進行修改。"
L["ClearProfile"] = "清除配置"
L["ClearProfileTip"] = "清空下方所有監控配置"
L["AvadaUnitOptionTip"] = "|nplayer: 監控玩家自身的法術|n|ntarget: 監控目標單位的法術|n|npet: 監控來自寵物的法術"
L["AvadaTypeOptionTip"] = "|nbuff: 監控增益法術|n|ndebuff: 監控減益法術|n|ncd: 監控法術冷卻時間|n|nitem: 監控物品冷卻時間"
L["AvadaIDOptionTip"] = "輸入你想監控的法術ID或物品ID"
L["BankDepositTip"] = "|n左鍵雙擊存放"
L["AccountDepositTip"] = "|n左鍵雙擊存放所有戰團綁定物品，右鍵點擊切換存放模式。|n當按鈕邊框高亮時，將存放可交易的材料。"
L["LegacyItem"] = "舊資料片裝備"
L["SmoothBars"] = "平滑血條動畫"
...
L["GeneralCDFontSize"] = "通用冷卻數字字體大小"
L["GeneralCDFontSizeTip"] = "用於沒有獨立字體設定的按鈕，例如額外快捷列按鈕。"
L["RaidBuffType"] = "增益過濾器"
L["RaidDebuffType"] = "減益過濾器"
L["CDText"] = "冷卻計時文本"
L["DamageMeter"] = "美化内置傷害統計"
L["CooldownMgr"] = "美化冷卻管理"
L["AttachedError"] = "窗口2和窗口3不能互相依附到對方！"
L["AttachedTo"] = "依附窗口"
L["AttachedToTip"] = "選擇你要依附的目標窗口。"
L["AttachedPoint"] = "依附錨點"
L["AttachedPointTip"] = "選擇你要依附窗口的錨點位置。"
L["Window1"] = "1號窗口"
L["Window2"] = "2號窗口"
L["Window3"] = "3號窗口"
L["RaidAuras"] = "顯示法術監控"
L["ShowCancelable"] = "顯示可取消法術"
L["Blizzard"] = "游戲内置規則"
L["Defensive"] = "防禦法術"
L["CombinedFilters"] = "組合過濾"
L["CentralizedBuffIcon"] = "居中顯示增益圖標"
L["CentralizedUtility"] = "居中顯示效能冷卻"
L["Disable Chat"] = "禁用聊天模塊"
L["PartyAbbr"] = "隊"
L["PartyLeaderAbbr"] = "隊長"
L["PartyGuideAbbr"] = "向導"
L["RaidAbbr"] = "團"
L["RaidLeaderAbbr"] = "團長" 
L["InstAbbr"] = "副"
...
L["GuildAbbr"] = "公"
L["OfficerAbbr"] = "官"
L["ChannelAbbr"] = "頻道名字簡寫"
L["LetterMode"] = "首字母模式"
L["LocaleMode"] = "本地化模式"
L["CombatAnimation"] = "進出戰鬥提示"
L["AttachPlayerPlate"] = "依附個人資源條"
L["PlateCC"] = "控場技能監控"
L["ColorTenth"] = "染色+小數點"
L["ColorText"] = "染色+整數"
L["WhiteTenth"] = "白色+小數點"
