...
L["ReminderTip"] = "|n根據自身職業，缺少特定Buff時進行提示。|n支持耐力/智力/戰鬥怒吼/野性印記/心靈之火/荊棘術/雄鷹守護/强擊光環/術士護甲/法師護甲。"
...
L["ClearClass"] = "漸變職業色"
L["PetCastbar"] = "寵物施法條"
L["ShowGroupRole"] = "顯示隊伍職責"
L["OffTankThreat"] = "啟用副坦仇恨"
L["OffTankThreatTip"] = "|n根據隊伍成員的職責，當目標仇恨在其他坦克身上時，使用自定義顔色。|n|n注意，確保你的隊友們選擇了正確的職責。"
L["HealPrediction"] = "顯示治療預估值"
