...
L["PlayerPlate HPHeight"] = "資源條血量高度"
L["PlayerPlate MPHeight"] = "資源條能量高度"
L["AuraWatch IconScale"] = "技能監視圖標縮放"
L["UFs HeightScale"] = "頭像高度縮放"
...
L["DeleteMode Enabled"] = "背包物品摧毀模式已啓用！你可以按住CTRL+ALT鍵，直接點擊摧毀背包中的傳家寶或者低於藍色精良品質的物品。"
L["DeleteMode Disabled"] = "背包物品摧毀模式已禁用。"
