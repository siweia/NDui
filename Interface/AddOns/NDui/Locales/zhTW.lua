...
L["ReloadUI Required"] = "需要重載插件生效設定"
...
L["Tutorial Page1"] = "下面將指導一些日常功能。|n|n此處將載入一些諸如|cffffcc00動作條、技能監控、團隊框架、名條|r等系統設定來改善插件的易用性。|n|n|cffff0000為防止出現各種異常，強烈建議|r你應用本頁的設定。"
...
L["Priority"] = "優先級"
L["Priority Intro"] = "|n法術監視圖標的顯示優先級。|n|n同一時間存在多個法術時，僅顯示優先級最高的那一個。|n|n最高為6，同時高亮該優先級的光環。|n|n留空則預設為2。"
...
L["Flash"] = "高亮"
L["Flash Intro"] = "|n勾選後，觸發時將高亮該法術圖標。"
...
L["Fadeout OOC"] = "脫戰後漸隱資源條"
L["Account Keystones"] = "帳號角色鑰石信息"
...
L["Cooldown*"] = "冷卻*"
L["Cooldown Intro"] = "|n輸入所設定法術的冷卻時間。|n|n注意，小隊的技能健康只支持固定冷卻時間的技能法術。|n|n對於獸王獵的野性守護等特殊技能無法準確實時監控。"
