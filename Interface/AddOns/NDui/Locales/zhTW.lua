...
L["Classcolor HpBar"] = "血條使用職業顏色"
L["Smoothcolor HpBar"] = "血條根據血量漸變顏色"
...
L["UFs Castbar"] = "啟用施法條"
L["UFs Totems"] = "頭像圖騰條"
L["UFs Resource"] = "職業特殊資源條"
L["UFs ExtraMana"] = "顯示額外法力值"
L["UFs CombatText"] = "顯示浮動戰鬥信息"
...
L["Auras Size"] = "法術圖標大小"
L["My Filter"] = "自身施放的法術過濾"
L["Other Filter"] = "他人施放的法術過濾"
L["Block All"] = "屏蔽全部法術"
L["Show All"] = "顯示全部自身施放的法術"
L["Aura Whitelist"] = "只顯示控制技能法術"
L["Aura Blacklist"] = "不顯示黑名單上的法術"
L["Aura Debufflist"] = "使用技能監視目標光環組"
L["Nameplate MinAlpha"] = "名條透明度最小值"
L["Nameplate Distance"] = "最大顯示距離（碼）"
L["Nameplate InsideView"] = "已接觸的名條停留在視野內"
L["Nameplate RaidMode"] = "啟用團隊戰術模式"
L["RaidMode ClickThrough"] = "友方名條禁用滑鼠互動"
L["RaidMode Matching"] = "紅綠配對模式"
L["RaidMode AuraScale"] = "友方玩家光環縮放"
L["RaidMode SmartNames"] = "未激活光環時隱藏友方名字"
L["DBM Skin"] = "啟用DBM皮膚"
L["Micromenu"] = "啟用微型菜單"
L["Menubar"] = "微型菜單欄"
