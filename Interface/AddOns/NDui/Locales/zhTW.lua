...
L["EnhancedPremadeTip"] = "|n添加雙擊快速申請、自動隱藏進組提示、美化列表職責圖標、自動邀請申請、顯示隊長分數、簡寫鑰石名字等。"
L["PlateHarmWidth"] = "敵方名條交互寬度"
L["PlateHarmHeight"] = "敵方名條交互高度"
L["PlateHelpWidth"] = "友方名條交互寬度"
L["PlateHelpHeight"] = "友方名條交互高度"
