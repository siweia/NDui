...
L["ColoredTargetRainbow"] = "目標血條彩虹色"
L["ColoredTargetRainbowTip"] = "啟用後，當前目標的血條將使用彩虹漸變色循環流動。需先啟用染色目標名條。"
...
L["MobTypeColoringTip"] = "|n在副本及隊伍實例中，根據怪物類型為敵方名條染色。|n|nBoss: 被標記為首領或等級高2級的怪物|n精英隊長: 被標記為精英隊長或等級高1級的精英怪物|n施法精英: 暴雪標記的精英施法怪物|n近戰精英: 其他精英怪物|n普通: 標準非精英怪物|n|n自訂單位、仇恨、目標及焦點顏色仍有更高優先級。"
L["BossColor"] = "首領顏色"
