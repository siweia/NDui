...
L["InstAlertOnlyTip"] = "|n勾選后，只在副本中進行上述通報，在野外及隨機副本中不進行通報。"
L["Interrupt"] = "打斷 - %s > %s"
L["Steal"] = "偷取 - %s > %s"
L["Dispel"] = "驅散 - %s > %s"
...
L["CustomTex"] = "自定義材質路徑"
L["CustomTexTip"] = "|n將你的自定義材質放置在Interface目錄下，然後輸入其名字，即可替換默認材質風格。|n如若替換後是純綠色，説明你的材質有誤，或尚未重新啓動客戶端。|n清空輸入框則關閉自定義功能。需要重載插件後生效。"
