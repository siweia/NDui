...
L["RaidAuras ClickThrough"] = "禁用法術的提示信息（點擊穿越）"
L["ClassColor RaidFrame"] = "團隊框體使用職業顏色"
L["Horizon RaidFrame"] = "小隊橫向排列"
L["RaidFrame Scale"] = "團隊框體大小縮放"
