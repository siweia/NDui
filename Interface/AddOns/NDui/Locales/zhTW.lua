...
L["Micromenu"] = "啟用微型菜單"
L["Menubar"] = "微型菜單欄"
L["Bar Line"] = "啟用快捷列背景線條"
L["Infobar Line"] = "啟用訊息條背景線條"
L["Chat Line"] = "啟用聊天窗口背景線條"
L["Menu Line"] = "啟用菜單欄背景線條"
...
L["FavouriteMode Enabled"] = "|n你現在可以點擊標記物品。|n若啟用了物品分類存放，還可以將其添加到偏好選擇分類中。|n此操作對垃圾物品無效。"
...
L["AuroraClassic warning"] = "檢測到你啟用了Aurora或者AuroraClassic，需禁用這類插件后才可正常工作。"
L["ReskinAlertFrames"] = "美化通知窗口"
L["BlockStranger"] = "屏蔽陌生人密語"
L["BlockStrangerTip"] = "|n啟用后，只接受來自隊友、好友以及公會成員的密語。"
