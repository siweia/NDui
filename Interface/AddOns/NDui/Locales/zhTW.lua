...
L["AWConfigTips"] = "|n你可以在每個設定的標題查看幫助信息。|n|n添加新監控後需要重載插件以生效設定。|n|n你可以按住 CTRL+ALT 鍵，點擊技能監控圖標來快速屏蔽，點擊目標Buff等圖標來解除屏蔽。"
L["Groups"] = "分組"
L["Player Aura"] = "玩家光環"
L["Target Aura"] = "目標光環"
...
L["DeleteUnitProfileTip"] = "|n輸入角色的全名來刪除其配置選擇信息，格式為'玩家名字-伺服器名字'。如果沒有填寫伺服器，則默認該角色與你同服。|n|n按ESC鍵清空輸入框，按Enter鍵確認。"
