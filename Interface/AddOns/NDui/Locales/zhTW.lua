...
L["MobTypeColoringTip"] = "|n在副本及隊伍實例中，根據怪物類型為敵方名條染色。|n|nBoss: 被標記為首領或等級高2級的怪物|n精英隊長: 被標記為精英隊長或等級高1級的精英怪物|n施法精英: 使用法力的精英怪物|n精英: 其他精英怪物|n普通: 標準非精英怪物|n|n自訂單位、仇恨、目標及焦點顏色仍有更高優先級。"
L["BossColor"] = "首領顏色"
L["LieutenantColor"] = "精英隊長顏色"
L["CasterColor"] = "施法精英顏色"
L["MeleeColor"] = "精英顏色"
