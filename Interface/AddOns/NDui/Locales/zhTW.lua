...
L["SpecRaidPosTip"] = "|n勾選后，小隊及團隊框架的位置，會按照你的專精進行存儲。"
...
L["RevertThreatTip"] = "|n啟用坦克模式染色后，對於非坦克職業，交換仇恨穩固和仇恨丟失的顔色。"
L["Secure Color"] = "仇恨穩固"
L["Trans Color"] = "仇恨不穩"
...
L["Mastery"] = "精通"
L["Versa"] = "應變"
L["Option* Tips"] = "|n帶有*號的選項即時生效，無需重載插件。|n|n雙擊滑塊選項的標題和顔色選擇的色塊，即可恢復初始設定。|n|n點擊部分選項的右側齒輪，可進行拓展設定。|n|n聊天欄輸入/ndui查看命令列表。"
...
L["PPOnFireTip"] = "|n啟用後，個人資源條的監控脫戰后將繼續生效。"
L["MDGuildBest"] = "顯示大秘境公會記錄"
L["MDGuildBestTip"] = "|n在史詩鑰石頁面顯示本周公會的大秘境記錄以及賬號角色鑰石信息。"
L["CustomTex"] = "自定義材質路徑"
L["CustomTexTip"] = "|n將你的自定義材質放置在Interface目錄下，然後輸入其名字，即可替換默認材質風格。|n如若替換后是純綠色，説明你的材質有誤，或尚未重新啓動客戶端。|n清空輸入框則關閉自定義功能。需要重載插件后生效。"
...
L["DispellableOnlyTip"] = "|n只顯示你可以驅散的負面效果。|n如果關閉，將始終顯示魔法、詛咒、疾病及中毒效果。|n對於你可以驅散的法術，圖標邊框是帶有顔色的。"