...
L["Garbage collected"] = "释放內存"
L["ManulCollect"] = "整理内存"
L["AutoCollect"] = "自动整理内存"
L["My Position"] = "我的位置"
L["System"] = "系統"
L["Home Latency"] = "本地延迟"
L["World Latency"] = "世界延迟"
L["CPU Usage"] = "显示CPU占比"
L["Toggle CPU Usage"] = "你需要重载界面来启用这个功能。"
