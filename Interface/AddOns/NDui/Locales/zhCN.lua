...
L["CustomJunkList"] = "自定义垃圾列表"
L["Incorrect ItemID"] = "你输入的物品ID不存在。"
L["CustomJunkListTip"] = "|n输入你想归类为垃圾的物品ID。|n|n当你开启自动出售垃圾时，这些物品也将被一同售出。|n|n物品列表是账号共享的。"
