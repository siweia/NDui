...
L["ColoredTargetRainbow"] = "目标血条彩虹色"
L["ColoredTargetRainbowTip"] = "启用后，当前目标的血条将使用彩虹渐变色循环流动。需先启用染色目标姓名板。"
...
L["MobTypeColoringTip"] = "|n在副本及队伍实例中，根据怪物类型为敌方姓名板染色。|n|nBoss: 被标记为首领或等级高2级的怪物|n精英队长: 被标记为精英队长或等级高1级的精英怪物|n施法精英: 暴雪标记的精英施法怪物|n近战精英: 其他精英怪物|n普通: 标准非精英怪物|n|n自定义单位、仇恨、目标及焦点颜色仍有更高优先级。"
L["BossColor"] = "首领颜色"
L["LieutenantColor"] = "精英队长颜色"
L["CasterColor"] = "施法精英颜色"
L["MeleeColor"] = "近战精英颜色"
