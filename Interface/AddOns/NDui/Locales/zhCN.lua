...
L["MobTypeColoringTip"] = "|n在副本及队伍实例中，根据怪物类型为敌方姓名板染色。|n|nBoss: 被标记为首领或等级高2级的怪物|n精英队长: 被标记为精英队长或等级高1级的精英怪物|n施法精英: 使用法力的精英怪物|n精英: 其他精英怪物|n普通: 标准非精英怪物|n|n自定义单位、仇恨、目标及焦点颜色仍有更高优先级。"
L["BossColor"] = "首领颜色"
