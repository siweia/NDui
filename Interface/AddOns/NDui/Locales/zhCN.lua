...
L["MultiRows"] = "背包分组排序"
L["MultiRowsTip"] = "|n启用后，当你开启背包分类存放时，将以4组为列排序，以适应多过滤启用的情况。"
...
L["InfobarStrTip"] = "|n根据你输入的字符组合对信息条进行排序:|n[guild] 公会|n[friend] 好友|n[ping] 延迟|n[fps] 帧数|n[zone] 地点|n[spec] 专精|n[dura] 耐久|n[gold] 金币|n[time] 时间|n|n注意单词的拼写及大小写，清空输入框将重置设置。"