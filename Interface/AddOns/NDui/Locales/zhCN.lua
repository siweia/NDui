...
L["Tutorial Page4"] = "|cffff0000注意: 本页的设置为账号共享。|r|n|n最后一步，将导入Skada、DBM、BigWigs的默认位置等设置（不会锁定），以使其更符合NDui的整体风格。|n|n你也可以在|cffffcc00控制面板-界面美化|r里取消它们的皮肤，一切取决于自己。"
...
L["AWConfigTips"] = "|n你可以在每个选项的标题查看帮助信息。|n|n添加新监控后需要重载插件生效。|n|n你可以按住 CTRL+ALT 键，点击技能监控图标来快速屏蔽，点击目标Buff等图标来移除屏蔽。"
L["Groups"] = "分组"
L["Player Aura"] = "玩家光环"
L["Target Aura"] = "目标光环"
