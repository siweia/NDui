...
L["Tutorial Page1"] = "下面将指导一些日常功能。\n\n此处将加载一些诸如|cffffcc00动作条、技能监控、团队框体、姓名板|r等系统设置以改善日常的易用性。\n\n|cffff0000为防止各种异常，强烈建议|r你应用本页的设置。"
L["Tutorial Page2"] = "接下来会载入|cffffcc00并锁定|r聊天窗口的大小以及位置。\n\n你之后可以在|cffffcc00控制面板-聊天窗口|r里取消锁定。\n\n|cffff0000注意:|r\n\n|cff00ccff当你按住Shift键时，在聊天窗口滚动鼠标滚轮，可以快速翻至页首或页尾。\n\n底部的长条点击可以进入相应的频道。|r"
L["Tutorial Page3"] = "|cffff0000注意: 本页的设置为账号共享。|r\n\n这里会载入默认推荐的UI缩放数值，以达到最优的表现效果。\n\n你之后可以在|cffffcc00控制面板-通用设置|r里选取一个适合自己的UI缩放数值。"
...
L["PlayerPlate HPHeight"] = "资源条血量高度"
L["PlayerPlate MPHeight"] = "资源条能量高度"
L["AuraWatch IconScale"] = "技能监控图标缩放"
L["UFs HeightScale"] = "头像高度缩放"
...
L["DeleteMode Enabled"] = "按住CTRL+ALT键，可直接点击摧毁背包中的传家宝或者低于蓝色精良品质的物品。"
