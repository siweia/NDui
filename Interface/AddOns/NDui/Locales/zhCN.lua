...
L["UnlockUI"] = "界面移动"
L["FramePreview"] = "框体预览"
L["FramePreviewTip"] = "实时按当前设置绘制团队框体示意，尺寸与光环图标调整即时可见，无需重载。"
L["PreviewRaidTitle"] = "团队  %dx%d  |  能量 %d  |  图标间距 %d"
L["PreviewPartyTitle"] = "小队  %dx%d  |  能量 %d  |  图标间距 %d"
L["PreviewAuraInfo1"] = "生命值 %s  |  增益 %dpx×%d  |  减益 %dpx×%d  |  大减益 %s"
L["PreviewAuraInfo2"] = "增益CD %s(%dpx)  |  减益CD %s(%dpx)  (尺寸改动需 /reload)"
L["PreviewOn"] = "开"
L["PreviewOff"] = "关"
L["PreviewCornerInfo"] = "边角指示器 %s  |  尺寸 %dpx  |  模式 %s  |  %d个"
