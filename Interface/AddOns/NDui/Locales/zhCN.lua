...
L["BossAuraFrame"] = "首领框体"
L["ArenaAuraFrame"] = "竞技场框体"
...
L["CustomUnitsTip"] = "|n启用后，部分目标的姓名板将以特殊颜色显示。|n你可以自定义这个颜色和需要染色的目标列表。|n|n在副本内这个功能可能失效。"
...
L["InstAlertOnlyTip"] = "|n勾选后，只在副本中进行上述通报，在野外及随机副本中不进行通报。"
L["Interrupt"] = "打断 - %s > %s"
L["Steal"] = "偷取 - %s > %s"
L["Dispel"] = "驱散 - %s > %s"
...
L["Show SpecLevelByShift"] = "仅按住Shift时显示装等"
...
L["UIWidgetPowerBar"] = "UIWidget能量条"
...
L["iLvlToShow"] = "物品等级阈值"
L["iLvlToShowTip"] = "|n需配合过滤低等级装备使用，单独归纳低于所设装等阈值的装备。"
L["FlatMode"] = "扁平风格按键"
L["Shadow"] = "显示背景阴影边框"
L["BgTex"] = "显示背景浅色线条"
L["SkinAlpha"] = "背景美化透明度"
...
L["BlockRequest"] = "阻止陌生人队伍申请"
L["BlockRequestTip"] = "|n启用后，只接受来自好友以及公会成员的队伍申请通知。"
...
L["FilterStone"] = "过滤始源之石"
L["FilterAOE"] = "过滤战团装绑"
L["FilterLegacy"] = "过滤旧资料片装备"
L["FilterDecor"] = "过滤住宅装饰"
L["Max Rank"] = "最高等级"
...
L["KeybindingTip"] = "你甚至可以为法术书技能和宏直接绑定快捷键，无需拖动到动作条。"
...
L["PlateCastbarGlowTip"] = "|n当目标施放重要的法术时，在施法条显示高亮箭头。"
...
L["MobTypeColoring"] = "副本怪物类型染色"
L["MobTypeColoringTip"] = "|n在副本及队伍实例中，根据怪物类型为敌方姓名板染色。|n|nBoss: 被标记为首领或等级高2级的怪物|n精英队长: 被标记为精英队长或等级高1级的精英怪物|n精英: 其他精英怪物|n普通: 标准非精英怪物|n|n自定义单位、仇恨、目标及焦点颜色仍有更高优先级。"
L["BossColor"] = "首领颜色"
L["LieutenantColor"] = "精英队长颜色"
L["MeleeColor"] = "精英颜色"
L["TrivialColor"] = "普通怪物颜色"
...
L["BagSearchTip"] = "|n点击对背包进行搜索。|n你可以搜索物品的名字或者装备的部位。|n输入boe可以直接搜索装绑，输入aoe搜索战团装绑，输入任务则搜索任务道具。|n输入资料片对应数字编号，搜索来自该资料片的物品。|n|n按ESC键清空输入框。"
L["NPCisTrue"] = "|cffff0000正|cffff7f00确|cffffff00的|cff00ff00任|cff00ffff务|cff0055ff目|cff8b00ff标"
L["QuestTool"] = "任务助手"
...
L["PlateAuras"] = "姓名板减益法术监控"
L["PlateBuffs"] = "姓名板增益法术监控"
...
L["MaxDebuffs"] = "最大减益数量"
L["ShowAll"] = "显示全部"
L["ShowAllOthersGray"] = "显示全部，他人灰色"
L["ShowDispell"] = "显示可驱散"
L["BlockOthers"] = "屏蔽他人"
L["DebuffColor"] = "减益法术边框染色"
L["DebuffColorTip"] = "|n根据减益法术的类型，染色其图标边框。"
L["AuraTypeColor"] = "法术类型边框染色"
L["AuraTypeColorTip"] = "|n根据法术类型，染色此监控组的图标边框。"
...
L["BloodlustStr"] = "%s效果结束，可以找机会开%s。"
L["NPCID or Name"] = "|n输入NPCID或者名字。|n|n你可以按住SHIFT键观察目标来获取NPCID。"
L["PlayerAbsorb"] = "显示玩家吸收盾数值"
L["PlayerAbsorbTip"] = "|n启用后，在玩家框体的血量旁显示当前吸收盾的数值。"
L["LeftButon"] = "左键"
L["RightButton"] = "右键"
L["MiddleButton"] = "中键"
L["Button4"] = "侧键1"
L["Button5"] = "侧键2"
L["InteractWidth"] = "交互宽度"
...
L["RaidTargetX"] = "目标标记横向偏移"
L["RaidTargetY"] = "目标标记纵向偏移"
L["GlowMode"] = "高亮模式"
L["Spacing"] = "间距"
L["AddPower"] = "额外能量条"
L["AddPowerTip"] = "|n显示暗牧、猫德等专精下的魔法值。"
L["AuraWatch MinCD"] = "冷却时间最小值"
L["MinCDTip"] = "|n法术的冷却时间必须大于设定值，才会进行监控。"
L["HideInCombat"] = "战斗中隐藏鼠标提示"
L["HideInCombatTip"] = "|n选择战斗中隐藏鼠标提示的方式。|n当切换为修饰键时，只有按住该键才可以在战斗中显示。"
L["DisableMapPOITooltipFix"] = "关闭大地图提示修复"
L["DisableMapPOITooltipFixTip"] = "|n勾选后，会停用NDui对大地图鼠标提示的污染修复。这可以解决插件冲突引起的鼠标提示框显示异常，但会使污染问题重新出现。"
L["HideDPSRole"] = "隐藏DPS职责图标"
L["ShowRoleMode"] = "职责图标显示方式"
L["PlateRange"] = "姓名板最大显示距离"
L["MoreFontSize"] = "更多字体大小"
L["EditFont"] = "输入框字体大小"
...
L["LowerItem"] = "低等级装备"
L["FilterLower"] = "过滤低等级装备"
L["ShowHealthAbsorb"] = "当期数值+吸收"
L["LeaderOnly"] = "仅拥有队伍权限时通报"
L["LeaderOnlyTip"] = "|n启用后，只有当你为小队队长、团长或团队助理时，才进行上述通报！"
L["SingingSocket"] = "特殊插槽增强"
L["SingingSocketTip"] = "|n启用后，在雷什裹布/海妖戒指的宝石页面添加一个快速选择宝石的小工具。"
L["CPU Usage Warning"] = "你开启了CPU使用记录. 这将导致性能下降. 你想禁用它还是继续？"
L["SortByRole"] = "按职责排序"
L["SortByRoleTip"] = "|n勾选后，按职责对小队成员进行排序。否则按照小队成员编号排序。"
L["SortAscending"] = "按升序排序"
L["SortAscendingTip"] = "|n勾选后，按升序对小队成员进行排序。否则按降序排序。"
L["LoadProfile"] = "加载配置"
L["LoadProfileTip"] = "将当前配置加载到监控中"
L["LoadProfileIndex"] = "加载配置: %s"
L["LoadProfileDefault"] = "已加载默认配置"
L["SaveProfile"] = "保存配置"
L["SaveProfileTip"] = "保存当前设置的监控配置"
L["Profile1Warning"] = "1号配置已被锁定，无法进行修改。"
L["ClearProfile"] = "清除配置"
L["ClearProfileTip"] = "清空下方所有监控配置"
L["AvadaUnitOptionTip"] = "|nplayer: 监控玩家自身的法术|n|ntarget: 监控目标单位的法术|n|npet: 监控来自宠物的法术"
L["AvadaTypeOptionTip"] = "|nbuff: 监控增益法术|n|ndebuff: 监控减益法术|n|ncd: 监控法术冷却时间|n|nitem: 监控物品冷却时间"
L["AvadaIDOptionTip"] = "输入你想监控的法术ID或物品ID"
L["BankDepositTip"] = "|n左键双击存放"
L["AccountDepositTip"] = "|n左键双击存放所有战团绑定物品，右键点击切换存放模式。|n当按钮边框高亮时，将存放可交易的材料。"
L["LegacyItem"] = "旧资料片装备"
L["SmoothBars"] = "平滑血条动画"
...
L["CDFontSize"] = "冷却文本字号"
L["GeneralCDFontSize"] = "通用冷却数字字号"
L["GeneralCDFontSizeTip"] = "用于没有独立字号设置的按钮，例如额外动作条按钮。"
L["RaidBuffType"] = "增益过滤器"
L["RaidDebuffType"] = "减益过滤器"
L["RaidBuffPerRow"] = "增益每行数量"
L["RaidDebuffPerRow"] = "减益每行数量"
L["CDText"] = "冷却计时文本"
L["DamageMeter"] = "美化内置伤害统计"
L["CooldownMgr"] = "美化冷却管理"
L["AttachedError"] = "窗口2和窗口3不能互相依附给对方！"
L["AttachedTo"] = "依附窗口"
L["AttachedToTip"] = "选择你要依附的目标窗口。"
L["AttachedPoint"] = "依附锚点"
L["AttachedPointTip"] = "选择你要依附窗口的锚点位置。"
L["Window1"] = "1号窗口"
L["Window2"] = "2号窗口"
L["Window3"] = "3号窗口"
L["RaidAuras"] = "显示法术监控"
L["ShowCancelable"] = "显示可取消法术"
L["Blizzard"] = "游戏内置规则"
L["Defensive"] = "防御法术"
L["CombinedFilters"] = "组合过滤"
L["NameplateRules"] = "姓名板规则"
L["CentralizedBuffIcon"] = "居中显示增益图标"
L["CentralizedUtility"] = "居中显示效能冷却"
L["Disable Chat"] = "禁用聊天模块"
L["PartyAbbr"] = "队"
L["PartyLeaderAbbr"] = "队长"
L["PartyGuideAbbr"] = "向导"
L["RaidAbbr"] = "团"
L["RaidLeaderAbbr"] = "团长" 
L["InstAbbr"] = "副"
...
L["GuildAbbr"] = "公"
L["OfficerAbbr"] = "官"
L["ChannelAbbr"] = "频道名称简写"
L["LetterMode"] = "首字母模式"
L["LocaleMode"] = "本地化模式"
L["CombatAnimation"] = "进出战斗提示"
L["AttachPlayerPlate"] = "依附个人资源条"
L["PlateCC"] = "控制技能监控"
L["ColorTenth"] = "染色+小数点"
L["ColorText"] = "染色+整数"
L["WhiteTenth"] = "白色+小数点"
