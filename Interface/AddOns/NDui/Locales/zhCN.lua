...
L["Tutorial Page3"] = "设置完毕！点击|cffffcc00应用|r后重载插件生效。|n|n|cffff0000注意:|r|n|n|cff00ccff小地图右键点击可以呼出追踪菜单，中键点击打开日历；|n|n信息条的每一个模块都有额外功能，请务必查看一遍；|n|n大部分的设置在控制面板中都可以修改！|r"
L["Help Title"] = "帮助说明"
