...
L["DescRole"] = "反向职责排列"
L["DescRoleTip"] = "|n勾选后，在增长方向上以伤害输出、治疗、坦克的顺序排列。|n|n不勾选，则在增长方向上以坦克、治疗、伤害输出的顺序排列。"
L["MMT29X4"] = "射击猎T29集中监控"
L["MMT29X4Tip"] = "|n启用后，在个人资源条上方显示4件套的集中值监控。|n|n启用时会重置数据，你需要重新装备套装以匹配计算。"
L["AutoHide"] = "自动关闭"
L["Speed"] = "速度"
