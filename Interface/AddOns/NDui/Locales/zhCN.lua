...
L["Nameplate RaidMode"] = "启用团队战术模式"
L["RaidMode ClickThrough"] = "友方姓名板禁用鼠标交互"
L["RaidMode Matching"] = "红绿配对模式"
L["RaidMode AuraScale"] = "友方玩家光环缩放"
L["RaidMode SmartNames"] = "未激活光环时隐藏友方名字"
L["DBM Skin"] = "启用DBM皮肤"
L["Micromenu"] = "启用微型菜单"
L["Menubar"] = "微型菜单栏"
