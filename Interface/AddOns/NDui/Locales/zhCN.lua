...
L["Tutorial Page2"] = "这里会载入默认推荐的UI缩放数值，以达到最优的表现效果。\n\n你之后可以在|cffffcc00控制面板-插件设置|r里选取一个适合自己的UI缩放数值。"
...
L["Own Interrupt"] = "仅通报自身的打断/偷取/驱散"
L["Interrupt"] = "%s 打断了 %s"
L["Steal"] = "%s 偷取了 %s"
L["Dispel"] = "%s 驱散了 %s"
L["Reflecting Prism"] = "[%s] 这个臭傻X又使用了 %s。"
L["Swapblaster"] = "[%s] 对 [%s] 使用了 %s。"
L["Reflecting Alert"] = "通报珠宝反光棱柱"
L["Swaping Alert"] = "通报工程移形换影装置"
L["SistersAlert Alert"] = "通报星界易伤情况（需权限）"
L["AntoranBlast Alert"] = "通报安托兰议会踩雷（需权限）"
...
L["Outdated NDui"] = "  你的|cff0080ffNDui|r已经过期，最新版本为 |cff70C0F5%s|r"
L["Fire Side"] = "火狗"
L["Shadow Side"] = "暗狗"
L["Spotted"] = "踩雷"
L["Minimap"] = "小地图"
