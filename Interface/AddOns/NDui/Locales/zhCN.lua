...
L["FilterRelic"] = "过滤刻希亚圣物"
L["FilterStone"] = "过滤始源之石"
L["KorthiaRelic"] = "刻希亚圣物"
L["Max Rank"] = "最高等级"
...
L["AutoDepositTip"] = "|n左键点击存放材料，右键点击切换存放模式。|n|n当按钮边框高亮时，每当打开银行，将自动存放背包中的材料。"
...
L["BagSearchTip"] = "|n点击对背包进行搜索。|n你可以搜索物品的名字或者装备的部位。|n输入boe可以直接搜索装绑，输入任务则搜索任务道具。|n|n按ESC键清空输入框。"
