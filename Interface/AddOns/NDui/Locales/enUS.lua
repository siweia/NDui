...
L["FramePreview"] = "Frame Preview"
L["FramePreviewTip"] = "Live schematic of the raid frame from current settings; size and aura icon changes show instantly without reload."
L["PreviewRaidTitle"] = "Raid  %dx%d  |  Power %d  |  Icon gap %d"
L["PreviewPartyTitle"] = "Party  %dx%d  |  Power %d  |  Icon gap %d"
L["PreviewAuraInfo1"] = "Health %s  |  Buffs %dpx x%d  |  Debuffs %dpx x%d  |  Big defensives %s"
L["PreviewAuraInfo2"] = "Buff CD %s(%dpx)  |  Debuff CD %s(%dpx)  (size change needs /reload)"
L["PreviewOn"] = "On"
L["PreviewOff"] = "Off"
L["PreviewCornerInfo"] = "Corner Indicator %s  |  Size %dpx  |  Mode %s  |  %d"
