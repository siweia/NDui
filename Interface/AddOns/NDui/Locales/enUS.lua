...
L["FriendPlateTip"] = "|nClick the gear button to setup nameplate size.|n|nIf enabled, you can separate nameplate size for friendly units.|nIf disabled, all nameplates will use the settings for hostile units.|n|nYou must disable option 'Name Only Mode' to take effect 'Friend Nameplate Size.'"
