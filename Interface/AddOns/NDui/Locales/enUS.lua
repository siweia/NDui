...
L["BossAuraFrame"] = "Boss Frame"
L["ArenaAuraFrame"] = "Arena Frame"
...
L["CustomUnitsTip"] = "|nIf enabled, some units' nameplate health would color by custom color.|nYou can customize the color and the units list to match your requirement.|n|nIt may only available outside dungeons."
L["UnitColor List"] = "CustomUnit List"
L["DBM Skin"] = "DBM Skin"
L["Micromenu"] = "Show Micromenu"
L["Menubar"] = "MicroMenu Bar"
L["Infobar Line"] = "Show Infobar Lines"
L["Chat Line"] = "Show Channels bar Lines"
...
L["ShowChatbar"] = "Show Channels bar"
...
L["iLvlToShowTip"] = "|nOnly words with filter lower ilvl. Separate items by ilvl threshold."
...
L["FilterLegacy"] = "Filter legacy items"
L["FilterDecor"] = "Filter Housing items"
L["Max Rank"] = "Max Rank"
...
L["DisableMapTip"] = "|nIf disabled, the map scale, mover and map fog reveal will all be disabled.|nIf you have addon Mapster enabled, the enhanced worldmap would turn off automatically."
...
L["PlateCastbarGlowTip"] = "|nIf unit is casting a major spell, show highlight arrows on its castbar."
...
L["MobTypeColoring"] = "Raid/Instance Mob Type Coloring"
L["MobTypeColoringTip"] = "|nColor enemy nameplates by mob type in raid and party instances.|n|nBoss: boss-flagged or +2 level mobs|nLieutenant: lieutenant-flagged or +1 level elite mobs|nElite: other elite mobs|nTrivial: standard non-elite mobs|n|nCustom unit, threat, target, and focus colors still take priority."
L["BossColor"] = "Boss Color"
L["LieutenantColor"] = "Lieutenant Color"
L["MeleeColor"] = "Elite Color"
L["TrivialColor"] = "Trivial Color"
...
L["BagSearchTip"] = "|nClick to search your bag items.|nYou can type in item names or item equip locations.|n'boe' for items that bind on equip, 'aoe' for items that warbound until equipped and 'quest' for quest items.|nUse expasion ID to find items from specific expansion.|n|nPress key ESC to clear editbox."
...
L["ShowAll"] = "Show all"
L["ShowAllOthersGray"] = "Show all, others gray"
...
L["AuraTypeColor"] = "Show aura type color"
L["AuraTypeColorTip"] = "|nAura icon borders show in their dispel type colors."
...
L["DisableMapPOITooltipFix"] = "Disable World Map tooltip fix"
L["DisableMapPOITooltipFixTip"] = "|nWhen checked, disables NDui's taint workaround for World Map tooltips. This can resolve abnormal tooltip display caused by addon conflicts, but the taint issue may return."
...
L["LowerItem"] = "Lower item level"
L["FilterLower"] = "Filter lower ilvl"
L["ShowHealthAbsorb"] = "Current+absorb"
L["LeaderOnly"] = "Leader alert only"
L["LeaderOnlyTip"] = "|nIf enabled, notifications only send by leader or assistant."
L["SingingSocket"] = "Enhanced gem sockets"
L["SingingSocketTip"] = "|nIf enabled, add a quick gem selection tool onto Siren ring and Reshii wraps."
...
L["LoadProfile"] = "Load Profile"
L["LoadProfileTip"] = "Load the current profile to resource bar."
L["LoadProfileIndex"] = "Load Profile: %s"
L["LoadProfileDefault"] = "Default profile loaded."
L["SaveProfile"] = "Save Profile"
L["SaveProfileTip"] = "Save settings to current slot."
L["Profile1Warning"] = "Profile 1 is protected, you can't modify on it."
L["ClearProfile"] = "Clear Profile"
L["ClearProfileTip"] = "Clear current settings."
L["AvadaUnitOptionTip"] = "|nplayer: Monitor your own spell|n|ntarget: Monitor target unit's spell|n|npet: Monitor pet's spell"
L["AvadaTypeOptionTip"] = "|nbuff: Monitor buff|n|ndebuff: Monitor debuff|n|ncd: Monitor spell cooldown|n|nitem: Monitor item cooldown"
L["AvadaIDOptionTip"] = "Enter the spell ID or item ID you want to monitor"
L["BankDepositTip"] = "|nDuoble click the left button to deposit reagents."
L["AccountDepositTip"] = "|nDuoble click the left button to deposit warband items, right click to swith deposit mode.|nIf the button border shown, the reagents from your bags would deposit into your warband bank as well."
...
L["PlayerPlate HealthBar"] = "Show HealthBar"
L["CDAnimation"] = "Cooldown Animation"
L["CDFontSize"] = "Cooldown FontSize"
L["GeneralCDFontSize"] = "General Cooldown Font Size"
L["GeneralCDFontSizeTip"] = "Used for buttons without an individual font-size setting, such as the Extra Action Button."
L["RaidBuffType"] = "Buff filters"
L["RaidDebuffType"] = "Debuff filters"
L["RaidBuffPerRow"] = "Buffs per row"
L["RaidDebuffPerRow"] = "Debuffs per row"
L["CDText"] = "Cooldown Text"
L["DamageMeter"] = "Reskin DamageMeter"
L["CooldownMgr"] = "Reskin CooldownMgr"
L["AttachedError"] = "Window2 and window3 cannot attached to each other."
L["AttachedTo"] = "Attached Target"
L["AttachedToTip"] = "Select the target window for attachment."
L["AttachedPoint"] = "Attached Anchor"
L["AttachedPointTip"] = "Select the attached anchor to target window."
L["Window1"] = "Window1"
L["Window2"] = "Window2"
L["Window3"] = "Window3"
L["RaidAuras"] = "RaidFrame Auras"
L["ShowCancelable"] = "Show cancelable auras"
L["Blizzard"] = "Blizzard filter"
L["Defensive"] = "Defensive auras"
L["CombinedFilters"] = "Combined filters"
L["NameplateRules"] = "Nameplate rules"
L["CentralizedBuffIcon"] = "Centralized buff icons"
L["CentralizedUtility"] = "Centralized utility cooldown"
L["Disable Chat"] = "Disable chat module"
L["PartyAbbr"] = "P"
...
L["GuildAbbr"] = "G"
L["OfficerAbbr"] = "O"
L["ChannelAbbr"] = "Channel Abbr"
L["LetterMode"] = "Letter Mode"
L["LocaleMode"] = "Locale Mode"
L["CombatAnimation"] = "Combat Animation"
L["AttachPlayerPlate"] = "Attached playerplate"
L["PlateCC"] = "Show CC auras"
