...
L["DeleteMode Enabled"] = "ItemDeleteMode enabled! You can destroy container item by holding CTRL+ALT. The item can be heirlooms or its quality lower then rare (blue)."
