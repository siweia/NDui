...
L["OverAbsorb"] = "Over absorb bar"
L["OverAbsorbTip"] = "|nIf enabled, show over absorb bar if unit absorb value greater than max health.|n|nThis option controls all the unitframes."
...
L["SingingSocket"] = "Siren ring enhanced"
L["SingingSocketTip"] = "|nIf enabled, add a quick singing sockets selection tool onto Siren ring panel."
