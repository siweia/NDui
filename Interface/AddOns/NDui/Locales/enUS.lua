...
L["ColoredTargetRainbow"] = "Rainbow Target Health Bar"
L["ColoredTargetRainbowTip"] = "When enabled, the target health bar cycles through rainbow gradient colors. Requires Colored Target to be enabled first."
...
L["MobTypeColoringTip"] = "|nColor enemy nameplates by mob type in raid and party instances.|n|nBoss: boss-flagged or +2 level mobs|nLieutenant: lieutenant-flagged or +1 level elite mobs|nCaster: Blizzard flagged elite mobs|nMelee: other elite mobs|nTrivial: standard non-elite mobs|n|nCustom unit, threat, target, and focus colors still take priority."
L["BossColor"] = "Boss Color"
L["LieutenantColor"] = "Lieutenant Color"
L["CasterColor"] = "Caster Color"
L["MeleeColor"] = "Melee Color"
