...
L["AWConfigTips"] = "|nGet more tips by mouseover each option header.|n|nYou need to reload UI after setting changed.|n|nYou can hold CTRL+ALT, and click AuraWatch icon to add spell into ignore list, or click UnitAura icon to remove spell from ignore list."
L["Groups"] = "Groups"
...
L["Profile"] = "Profile"
L["Profile Management"] = "Profile Manager (WIP)"
...
L["DeleteUnitProfileTip"] = "|nEnter the character name that you intend to delete its profile, the input format is 'UnitName-RealmName'. You only need to enter name if unit is in the same realm with you.|n|nPress key ESC to clear editbox, press key Enter to confirm."
