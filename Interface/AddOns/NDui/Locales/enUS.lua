...
L["DispellableOnlyTip"] = "If disabled, all the auras from magic, curse, disease and poison would show on raidframe. The icon border is colorful when dispellable."