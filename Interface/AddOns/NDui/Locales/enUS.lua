...
L["Tutorial Page1"] = "Here is the tutorial to improve your experiencing.\n\nNow click the button to load some default settings that suit for NDui, include nameplate, actionbar, raidframes.\n\n|cffff0000These are strongly recommended.|r"
...
L["DeleteMode Enabled"] = "You can destroy container item by holding CTRL+ALT. The item can be heirlooms or its quality lower then rare (blue)."
...
L["Horizon RaidFrame"] = "Horizontal PartyFrame"
