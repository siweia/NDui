...
L["CustomJunkList"] = "Custom Junk List"
L["Incorrect ItemID"] = "Incorrect ItemID."
L["CustomJunkListTip"] = "|nEnter the itemID that you want to classify as junk.|n|nIf 'Autosell Junk' enabled, these items would be sold as well.|n|nThe list is saved for all the characters."
