...
L["DeleteMode Enabled"] = "ItemDeleteMode enabled! You can destroy container item by holding CTRL+ALT. The item quality must be lower then rare (blue)."
...
L["Import data error"] = "Incomplete data, fail to import."
