...
L["QuakeTimerTip"] = "|nShow quake timer on top of player castbar, for affix quaking in mythic dungeons."
L["BloodlustStr"] = "%s duration ceased, don't forget to cast %s if necessary."
L["Reset nameplate filter"] = "Are you sure to reset nameplate filter list?"