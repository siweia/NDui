...
L["BlizzMoverTip"] = "If enabled, save CharacterFrame anchor after you move it. Hold CTRL and left click to reset its default anchor.|n|nAlso support QuestLogFrame."