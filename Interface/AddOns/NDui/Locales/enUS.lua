...
L["FriendPlateTip"] = "|nIf enabled, you can separate plate size for friendly units. If disabled, all nameplates will use the settings for hostile units.|n|nClick the gear button to setup nameplate size.|n|nYou must disable option 'Name Only Mode' to take effect."
