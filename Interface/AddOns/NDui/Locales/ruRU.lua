...
L["CustomJunkListTip"] = "|nEnter the itemID that you want to classify as junk.|n|nIf 'Autosell Junk' enabled, these items would be sold as well." -- need translation