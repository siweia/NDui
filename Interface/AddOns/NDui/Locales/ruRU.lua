...
L["MobTypeColoringTip"] = "|nОкрашивает неймплейты врагов по типу моба в рейдах и подземельях.|n|nБосс: мобы с флагом босса или на 2 уровня выше|nЛейтенант: мобы с флагом лейтенанта или элитные мобы на 1 уровень выше|nКастер: элитные кастующие мобы|nМили: другие элитные мобы|nОбычный: стандартные не-элитные мобы|n|nЦвета особых целей, угрозы, цели и фокуса всё ещё имеют приоритет."
L["BossColor"] = "Цвет Босса"
L["LieutenantColor"] = "Цвет Лейтенанта"
L["CasterColor"] = "Цвет Кастера"
L["MeleeColor"] = "Цвет Ближника"
