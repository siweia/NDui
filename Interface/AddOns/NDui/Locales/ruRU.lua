...
L["ReminderTip"] = "|nНапомнить вам, когда отсутствует заклинание собственного класса.|nПоддерживаются: Стойкость, Яды, Чародейский интеллект, Боевой крик, Внутренный огонь, Знак дикой природы, Корни, Дух ястреба, Аура верного выстрела, Warlock armors, Mage armors, Horn of winter, Righteous fury." -- need translation
