...
L["Option* Tips"] = "|nНастройки не отмеченные звёздочкой (*) требуют перезагрузки UI.|nDouble click on slider header would reset its value.|nClick the GEAR ICON next to option for extra settings." -- need translation
