...
L["ColoredTargetRainbow"] = "Радужная полоса цели"
L["ColoredTargetRainbowTip"] = "При включении полоса здоровья цели переливается радужным градиентом. Требуется включенный 'Цветной неймплейт цели'."
