...
L["VerticalTotems"] = "Vertical TotemBar" -- need translation
...
L["PlayerPlate Fadeout"] = "Fadeout after combat" -- need translation
L["PlayerPlate FadeoutAlpha"] = "Fadeout Alpha" -- need translation
...
L["MinimapCalendarTip"] = "|nIf enabled, show minimap calendar icon on minimap.|nYou can simply click mouse middle button on minimap to toggle calendar even without this option." -- need translation
...
L["Reset anchor"] = "Reset default anchor" -- need translation
L["Hide panel"] = "Hide panel mover" -- need translation
...
L["JunkMode Enabled"] = "|nКлик, чтобы отметить вещи как хлам.|nЕсли 'Автопродажа хлама' включена, эти вещи также будут проданы.|nСписок сохраняется на весь аккаунт." 
...
L["UnbindTip"] = "Press the escape key or right click to unbind this action." -- need translation
...
L["ExtraQuestButton"] = "ExtraQuestButton" -- need translation
L["NDui_CustomBar"] = "CustomBar" -- need translation
L["Enable CustomBar"] = "Enable CustomBar" -- need translation
L["CustomBarTip"] = "|nEnable an extra actionbar for you to customize." -- need translation
L["CustomBarFader"] = "CustomBar Fading" -- need translation
...
L["IncorrectExpansion"] = "Current version of NDui is only available in expansion 9.0, please roll back to version 5.10.0." -- need translation
L["BagSortMode"] = "BagSort Mode" -- need translation
L["BagSortDisabled"] = "BagSort has been disabled in GUI." -- need translation
L["Forward"] = "Forward" -- need translation
L["Backward"] = "Backward" -- need translation