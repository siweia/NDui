...
L["ActionBarTip"] = "|nЕсли выключено, то микроменю также будет недоступно."
...
L["ReminderTip"] = "|nНапомнить вам, когда отсутствует заклинание собственного класса.|nПоддерживаются: Стойкость, Яды, Чародейский интеллект, Боевой крик, Внутренный огонь, Знак дикой природы, Корни, Дух ястреба, Аура верного выстрела, Warlock armors, Mage armors."
...
L["LoCAlert"] = "Уведомление о потере контроля"
L["LoCAlertTip"] = "|nЕсли выбрано уведомляет о потере контроля от заклинаний.|nнапр. Слепота, Замораживающая ловушка."
L["InstAlertOnly"] = "Уведомлять только в подземельях"
L["InstAlertOnlyTip"] = "|nЕсли выбрано, уведомления будут только в позмельях. Никаких уведомлений в соло."
L["Interrupt"] = "Прервано - %s > %s"
L["Steal"] = "Украдено - %s > %s"
L["Dispel"] = "Рассеяно - %s > %s"
L["BrokenSpell"] = "Сбито - %s > %s"
L["LossControl"] = "ЛоС - %s > %s (%ss %s)"
...
L["AutoDismount"] = "Спешиваться у распорядителя"
L["AutoDismountTip"] = "|nАвтоматически спешиваться после выбора пункта назначения полёта."
...
L["MinimapHelp"] = "Прокрутите миникарту для увеличения или уменьшения масштаба. Если аддон 'alaCalendar' установлен, СКМ для включения календаря."
...
L["PlateCastbarGlow"] = "Подсветка значимых заклинания"
...
L["ColoredFocus"] = "Цветной индик.здоровья фокуса"
L["ColoredFocusTip"] = "|nЕсли включено,приоритет этого цвета индик.здоровья вашего фокуса будет выше, чем у настраиваемого цвета и цвета угрозы.|nНастроить свой цвет ниже."
L["FocusNP Color"] = "Цвет индик.здоровья фокуса"
L["Switch Mode"] = "Сменить режим"
L["DispellableOnly"] = "Только заклинания, которые можно развеять"
...
L["PetUnhappy"] = "%sВаш питомец [%s] готов убежать от вас."
L["PetBadMood"] = "%sВаш питомец [%s] в плохом настроении."
L["PetHappy"] = "%sВаш питомец [%s] теперь счастлив."
...
L["AspectBar"] = "Панель духов"
L["AspectSize"] = "Размер иконки духа"
L["VerticleAspect"] = "Вертикальная панель духов"
L["TradeSearchTip"] = "|nНайдите нужное название рецепта, нажмите клавишу ESC, чтобы очистить ввод.|n"
L["InvalidName"] = "Некорректные данные."
L["NoMatchReult"] = "Нет подходящих результатов."
...
L["Minimap DiffFlag"] = "Показывать сложность на миникарте"
L["DiffFlagTip"] = "|nЕсли включено, показывает иконку сложности в правом верхнем углу миникарты."
...
L["ClampTargetPlate"] = "Захват индик.здоровья"
L["ClampTargetPlateTip"] = "|nЕсли выбрано, индикатор здоровья цели всегда остаётся на экране."
...
L["TotemBars"] = "Totem Actionbar" -- need translation