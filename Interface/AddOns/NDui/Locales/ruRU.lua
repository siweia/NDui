...
L["SpecRaidPosTip"] = "|nЕсли включено, Груп/рейдфреймы будут сохранять свои позиции для каждого спека"
...
L["WhisperKeywordTip"] = "|nSetup whisper invite keywords. If you have more than one word, press key SPACE in between." -- need translation
L["Default Channel"] = "Стандартные имена каналов"
L["Guild Invite Only"] = "Принимать приглашение только из гильдии"
L["EasyMark"] = "Easy target marker" -- need translation
L["EasyMarkTip"] = "|nHold your prefer modified key, and left click unit to select raid target mark." -- need translation
...
L["DBMCount"] = "Отсчёт в секундах"
L["DBMCountTip"] = "|nSetup countdown timer for raid tool.|nRequire DBM or Bigwigs." -- need translation
...
L["ChatFilterWhiteListTip"] = "|nПоказывать сообщения которые содержат нижеприведённый слова. Отключено если пусто. Use key SPACE between multi words." -- need translation
L["FilterListTip"] = "|nОтфильтровывает сообщения, содержащие эти слова. Use key SPACE between multi words." -- need translation
L["CustomUnitTips"] = "|nВведите имя юнита или NPC ID. Use key SPACE between different units.|nВы можете увидеть NPC ID в подсказке, удерживая SHIFT." -- need translation
...
L["ColoredTarget"] = "Цветной таргет Нэймплейт"
L["ColoredTargetTip"] = "|nЕсли включено, цвет вашего таргета неймплейта будет выше, чем у настраиваемого цвета и цвета угрозы.|nНастроить свой цвет ниже."
L["TargetNP Color"] = "Таргет Нэймплейт цвет"
...
L["PlayerPlate OnFire"] = "Всегда обновляйть ауры"
L["PPOnFireTip"] = "|nЕсли включено, ауры на плашке игрока продолжат обновляться даже вне боя."
L["MDGuildBest"] = "Показать Mythic + GuildBest"
...
L["Undress"] = "Undress" -- need translation
