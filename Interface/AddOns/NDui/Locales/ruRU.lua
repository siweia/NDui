...
L["Power Offset"] = "Вертикальный отступ панели ресурса"
...
L["ShowCorruptionRank"] = "Уровень порчи"
...
L["No key set"] = "Не назначена клавиша"
L["KeyIndex"] = "Номер"
...
L["ShowChatBackground"] = "Показывать фон чата"
