...
L["PetTrashTip"] = "|nВ патче 9.1, вы можете купить 3 питомцев используя специальный хлам. Если опция включена, эти валюты будут отсортированы в фильтр Коллекций и не будут проданы торговцу автоматически."
L["MythicScore"] = "Очки M+: %s"
L["MDScore"] = "Показывать рейтинг М+"
L["MDScoreTip"] = "|nЕСли включено, показываеть М+ рейтинг в текущем сезоне.|n Скрыто, есть М+ рейтинг равен НУЛЮ."
L["ToggleCastbarTip"] = "|nОпция для переключения полос заклинаний, не требует перезагрузки интерфейса."
