...
L["FilterQuest"] = "Filter quest items" -- need translation
...
L["TakeAll"] = "Take all" -- need translation
...
L["Reset current profile?"] = "Are you sure to reset your current profile?" -- need translation
L["Apply selected profile?"] = "Are you sure to switch to the selected profile?" -- need translation
L["Download selected profile?"] = "Are you sure to replace your current profile with the selected one?" -- need translation
L["Upload current profile?"] = "Are you sure to replace the selected profile with your current one?" -- need translation
L["DefaultCharacterProfile"] = "Character Profile" -- need translation
L["DefaultSharedProfile"] = "Shared Profile " -- need translation
L["ProfileName"] = "Profile Name" -- need translation
L["ProfileNameTip"] = "|nCustomize your profile name. If emty the editbox, the name would reset to default string.|n|nPress KEY ENTER when you finish typing." -- need translation
L["ResetProfile"] = "Reset Profile" -- need translation
L["ResetProfileTip"] = "|nReset your current profile, and load default settings. Requires UI reload." -- need translation
L["SelectProfile"] = "Select Profile" -- need translation
L["SelectProfileTip"] = "|nSwitch to the selected profile, requires UI reload." -- need translation
L["DownloadProfile"] = "Replace Current Profile" -- need translation
L["DownloadProfileTip"] = "|nReplace the current profile with the selected one, requires UI reload." -- need translation
L["UploadProfile"] = "Replace Selected Profile" -- need translation
L["UploadProfileTip"] = "|nReplace the selected profile with the current using one." -- need translation
L["Profile"] = "Profile" -- need translation
L["Profile Management"] = "Profile Management" -- need translation
L["Profile Description"] = "You can manage your addon profile, please backup your settings before start. The default settings is based on your character, won't share within the same account. You can switch to the shared profile to share between your characters, and get rid of data transfer.|nData export and import only support the current profile." -- need translation
L["SharedCharacters"] = "Shared Characters" -- need translation
...
L["CooldownRemaining"] = "%s cooldown remaining %ds" -- need translation
L["CooldownCompleted"] = "%s is now available." -- need translation
