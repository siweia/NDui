...
L["Trigger"] = "Триггер"
L["Trigger Intro"] = "|nAdd trigger on cooldown timer.|n|nOnAuraGain: Trigger timer once you gain this aura.|n|nOnCastSuccess: Trigger timer once you cast this spell successfully, the spell must be recorded in combat log.|n|nUnitCastSucceed: Trigger timer once you cast this spell successfully，the spell must be recorded in event 'UNIT_SPELLCAST_SUCCEEDED'." -- need translation
