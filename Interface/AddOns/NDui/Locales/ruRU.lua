...
L["BossAuraFrame"] = "Рамка босса"
L["ArenaAuraFrame"] = "Рамка арены"
...
L["CustomUnitsTip"] = "|nЕсли выбрано,то появится возможность выбрать цвет панелей некоторых целей|nВы сможете изменить цвет панелей по своим предпочтениям.|n|nIt may only available outside dungeons."
...
L["MobTypeColoring"] = "Окраска по типу моба (Рейд/Данж)"
L["MobTypeColoringTip"] = "|nОкрашивает неймплейты врагов по типу моба в рейдах и подземельях.|n|nБосс: мобы с флагом босса или на 2 уровня выше|nЛейтенант: мобы с флагом лейтенанта или элитные мобы на 1 уровень выше|nЭлита: другие элитные мобы|nОбычный: стандартные не-элитные мобы|n|nЦвета особых целей, угрозы, цели и фокуса всё ещё имеют приоритет."
L["BossColor"] = "Цвет Босса"
L["LieutenantColor"] = "Цвет Лейтенанта"
L["MeleeColor"] = "Цвет элиты"
L["TrivialColor"] = "Цвет Рядового"
...
L["PlateAuras"] = "Дебаффы индикаторов здоровья"
L["PlateBuffs"] = "Баффы индикаторов здоровья"
...
L["ShowAllOthersGray"] = "Показывать всё, чужие серые"
...
L["AuraTypeColor"] = "Показывать цвет типа ауры"
L["AuraTypeColorTip"] = "|nРамки значков окрашиваются в цвет типа рассеивания."
...
L["DisableMapPOITooltipFix"] = "Отключить исправление подсказок карты мира"
L["DisableMapPOITooltipFixTip"] = "|nОтключает исправление NDui для taint подсказок карты мира. Это может устранить проблемы отображения подсказок из-за конфликтов аддонов, но проблема taint может появиться снова."
...
L["GeneralCDFontSize"] = "Общий размер шрифта времени восстановления"
...
L["NameplateRules"] = "Правила индикаторов здоровья"
