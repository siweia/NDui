...
L["PreviewAuraInfo"] = "Здоровье %s  |  Баффы %dpx x%d  |  Дебаффы %dpx x%d  |  Большие защитные %s  |  Текст КД бафф %s(%dpx)  |  Текст КД дебафф %s(%dpx)  (изменение размера требует /reload)"
L["PreviewOn"] = "Вкл"
L["PreviewOff"] = "Выкл"
