...
L["SpecRaidPosTip"] = "|nЕсли включено, рамки группы и рейда будут сохранять свои позиции для каждой специальности"
...
L["ExplosiveAlertTip"] = "|nЕсли выбрано, отправлять кол-во сфер в вашу группу после завершения М+."
...
L["RaidBuffIndicatorTip"] = "|nПоказывать бафы и дебафы в углу и на границе рамок рейда."
...
L["Show ConduitInfo"] = "Показать информацию о проводнике"
...
L["ExplosivesScaleTip"] = "|nЕсли включено,индик.здоровья Взрывоопасной сферы будет увеличен в 1.5 раза."
...
L["ShowRaidBuff"] = "Показывать бафы рейда"
L["ShowRaidBuffTip"] = "|nПоказывает бафы на рамках рейда следуя логике API, до 3х иконок.|n|nЛучше не использовать с Угловым индикатором бафов."
L["ShowRaidDebuff"] = "Показывать дебафы рейда"
L["ShowRaidDebuffTip"] = "|nПоказывает дебафы на рамках рейда соедуя логике API, до 3х иконок."
L["RaidBuffSize"] = "Размер бафов рейда"
L["RaidDebuffSize"] = "Размер дебафов рейда"
L["SmartRaid"] = "Рамки рейда по размеру группы"
L["SmartRaidTip"] = "|nЕсли включено, отображает рамки рейда только тогда, когдо в вашей группе 5 человек.|nЕсли выключено, показывает рамки рейда, если в рейде. Рамки группы, если в группе =).|n|n Доступно только если включены рамки группы."
L["EquipColor"] = "Рамки одетых вещей"
