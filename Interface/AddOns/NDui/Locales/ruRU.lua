...
L["FramePreview"] = "Предпросмотр фрейма"
L["FramePreviewTip"] = "Схема рейд-фрейма по текущим настройкам в реальном времени; размер и иконки аур видны сразу без перезагрузки."
L["PreviewRaidTitle"] = "Рейд  %dx%d  |  Энергия %d  |  Отступ иконок %d"
L["PreviewPartyTitle"] = "Группа  %dx%d  |  Энергия %d  |  Отступ иконок %d"
L["PreviewAuraInfo1"] = "Здоровье %s  |  Баффы %dpx x%d  |  Дебаффы %dpx x%d  |  Большие защитные %s"
L["PreviewAuraInfo2"] = "Текст КД бафф %s(%dpx)  |  Текст КД дебафф %s(%dpx)  (изменение размера требует /reload)"
L["PreviewOn"] = "Вкл"
L["PreviewOff"] = "Выкл"
L["PreviewCornerInfo"] = "Угловой индикатор %s  |  Размер %dpx  |  Режим %s  |  %d"
