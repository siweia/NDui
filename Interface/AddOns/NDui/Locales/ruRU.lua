...
L["InterruptAlert"] = "Interrupt alert in group" -- need translation
L["OwnInterrupt"] = "Own interrupt only" -- need translation
L["DispellAlert"] = "Dispell alert in group" -- need translation
L["OwnDispell"] = "Own dispell only" -- need translation
...
L["InstAlertOnly"] = "Only alert in instance" -- need translation
L["InstAlertOnlyTip"] = "|nIf checked, the notifications above only alert in instance. No longer alert in wild and LFG group." -- need translation
...
L["RaidBuffIndicatorTip"] = "|nShow buffs or debuffs on raidframe edge and corner." -- need translation
...
L["FilterRelic"] = "Filter Korthia relics" -- need translation
L["KorthiaRelic"] = "Korthia Relics" -- need translation
...
L["ShowRaidBuff"] = "Show RaidBuffs" -- need translation
L["ShowRaidBuffTip"] = "|nShow buffs on raidframe by blizzard API logic, up to 3 icons.|n|nBetter not to use this with Corner BuffIndicator." -- need translation
L["ShowRaidDebuff"] = "Show RaidDebuffs" -- need translation
...
L["MultiRows"] = "Anchor by rows" -- need translation
L["MultiRowsTip"] = "|nIf item filter enabled, every four bags will anchor into one row." -- need translation
