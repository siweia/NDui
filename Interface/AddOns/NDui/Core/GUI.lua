...
G.OptionList = { -- type, key, value, name, horizon, doubleline
	...
	[2] = {
		...
		{3, "Bags", "iLvlToShow", L["iLvlToShow"].."*", true, {1, 500, 1}, nil, L["iLvlToShowTip"]},
		{4, "Bags", "BagSortMode", L["BagSortMode"].."*", nil, {L["Forward"], L["Backward"], DISABLE}, updateBagSortOrder, L["BagSortTip"]},
