...
G.OptionList = { -- type, key, value, name, horizon, doubleline
	...
	[14] = {
		...
		{3, "ACCOUNT", "SmoothAmount", L["SmoothAmount"].."*", true, {.15, .6, .01}, updateSmoothingAmount, L["SmoothAmountTip"]},
	},
	[15] = {
	},
}
